          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div className="footer-logoarea">
                ...
                <p>
                  As HouseBox’s lead negotiator, Chris brings years of
                  experience in securing the best deals both.
                </p>
                <div className="space24" />
                <ul>
                  <li>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-content2">
                ...
                <ul>
                  ...
                  <li>
                    <Link href="mailto:houseboxesate.com">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="copyright text-center">
                <p>
                  ©Copyright {new Date().getFullYear()} - Housebox. All Right
                  Reserved
                </p>
              </div>
            </div>
